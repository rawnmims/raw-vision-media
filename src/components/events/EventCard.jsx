      ...
      >
        ...
        >
          ...
          <div className="relative h-[58%] overflow-hidden">
            ...
            <div className="relative z-30 h-full flex flex-col justify-between p-3">
              {/* brand row */}
              <div className="flex items-start justify-between">
                ...
                {event.featured && (
                  <span className="flex items-center gap-1 bg-raw-accent text-black px-2 py-0.5 rounded-full">
                    <Star size={9} className="fill-black" />
                    <span className="font-oswald text-[9px] font-bold tracking-widest uppercase">
                      Pro
                    </span>
                  </span>
                )}
              ...
              <div>
                ...
                <div className="flex items-end gap-2" title={formatDateShort(event.event_date)}>
                  <span
                    className="font-condensed text-5xl leading-[0.8] text-white"
                    style={{ textShadow: '0 2px 14px rgba(0,0,0,0.55)' }}
                  >
                    {day}
                  </span>
                  <div className="font-oswald text-[10px] tracking-widest uppercase text-white/85 leading-tight pb-1">
                    <div>{month}</div>
                    <div>&apos;{yearBadge}</div>
                  </div>
                </div>
...
function SkeletonCard({ isDark }) {
  return (
    ...
    >
      ...
      <div className={`h-9 ${isDark ? 'bg-gray-700' : 'bg-gray-300'}`} />
    </div>
  )
}
