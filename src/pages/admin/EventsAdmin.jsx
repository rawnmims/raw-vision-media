...
export default function EventsAdmin() {
  ...
  const load = () => {
    setLoading(true)
    eventService.getEvents({ visibility: undefined })
      .then(d => setEvents(d))
      .catch(() => setEvents([]))
  ...
  // Safe field updater — never overwrites unrelated fields
              ...
              >
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className={`font-oswald text-[10px] tracking-widest uppercase ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>
                      {event.year}
                    </p>
                  </div>
                  {event.featured && <Star size={12} className="text-raw-accent flex-shrink-0" />}
                </div>
                <span className={`hidden md:block w-24 font-oswald text-xs tracking-wider uppercase ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                  {event.category}
                </span>
                <span className={`hidden md:block w-24 font-oswald text-xs tracking-wider ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
          ...
          >
            ...
            >
              ...
              <div className="px-7 py-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                {/* Google Drive Folder — isolated onChange to prevent wiping form */}
                <div className="sm:col-span-2">
                ...
                <div className="sm:col-span-2">
                  ...
                  <CoverImageUploader
                    ...
                    onUpload={(url) => setField('cover_image', url)}
                    onClear={() => setField('cover_image', '')}
                  />
                  <input
                    name="cover_image"
                ...
                <div className="sm:col-span-2 flex items-center gap-3">
                  ...
                  <label
                    htmlFor="featured"
                    className={`font-oswald text-xs tracking-widest uppercase cursor-pointer ${isDark ? 'text-gray-300' : 'text-gray-600'}`}
                  >
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 justify-center flex items-center gap-2 px-4 py-3 bg-red-600 text-white font-oswald text-xs tracking-widest uppercase hover:bg-red-700 transition-colors"
                >
